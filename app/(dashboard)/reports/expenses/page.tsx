                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
                          <thead>
                            <tr style={{ color: '#64748B' }}>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>Tanggal transaksi</th>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>Ref</th>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>Deskripsi</th>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>Tipe</th>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>BU</th>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>Metode pembayaran</th>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>Proyek</th>
                              <th style={{ textAlign: 'left', padding: '8px 14px', fontWeight: '600' }}>Status</th>
                              <th style={{ textAlign: 'right', padding: '8px 14px', fontWeight: '600' }}>Total</th>
                            </tr>
                          </thead>
                          <tbody>
                            {g.items.map(e => (
                              <tr key={e.id} style={{ borderTop: '1px solid #F1F5F9' }}>
                                ...
                                <td style={{ padding: '8px 14px', textAlign: 'right', fontVariantNumeric: 'tabular-nums' }}>{formatIDR(e.total_payment)}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
